...
class ConveyorStreamSectionWidget extends StatefulWidget {
  ...
  const ConveyorStreamSectionWidget({
    super.key,
  ...
  @override
  State<ConveyorStreamSectionWidget> createState() => _ConveyorStreamSectionWidgetState();
}

class _ConveyorStreamSectionWidgetState extends State<ConveyorStreamSectionWidget> {
  @override
        ...
        children: [
          ...
          BlocBuilder<ConveyorBeltDamageBloc, ConveyorBeltDamageState>(
            builder: (context, state) {
              if (state is ConveyorStreamConnected) {
                ...
                final WebSocketAnalysisResponse analysis = state.analysis;
                return Container(
