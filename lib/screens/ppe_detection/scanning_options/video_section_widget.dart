// filepath: lib/screens/ppe_detection/scanning_options/video_section_widget.dart
...
class PpeVideoSectionWidget extends StatelessWidget {
  final PlatformFile? selectedFile;
  final VoidCallback onPickFile;
  const PpeVideoSectionWidget({
    super.key,
        ...
        BlocBuilder<PpeDetectionBloc, PpeDetectionState>(
          builder: (context, state) {
            if (state is PpeDetectionLoading) {
              ...
              final data = state.data; // PpeVideoResponse
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Note: This PPE endpoint returns only a simple {message, size} payload. If you expect detailed video metadata (resolution, fps, frames, duration), update the API or serializer.',
