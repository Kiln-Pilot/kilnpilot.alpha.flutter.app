// filepath: lib/screens/rock_size_detection/scanning_options/image_section_widget.dart
import 'dart:convert';
...
class RockImageSectionWidget extends StatelessWidget {
  final PlatformFile? selectedFile;
  final VoidCallback onPickFile;
  const RockImageSectionWidget({
    super.key,
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  ClipRRect(borderRadius: BorderRadius.circular(12), child: Image.memory(originalImageBytes, fit: BoxFit.contain, height: 300)),
                                ],
                              ),
                            ),
                            ...
                            Expanded(
                              child: Column(
                                children: [
                                  ...
                                  const SizedBox(height: 8),
                                  ClipRRect(borderRadius: BorderRadius.circular(12), child: Image.memory(base64Decode(data.annotatedImageBase64!), fit: BoxFit.contain, height: 300)),
                                ],
                              ),
                            ),
                        ],
