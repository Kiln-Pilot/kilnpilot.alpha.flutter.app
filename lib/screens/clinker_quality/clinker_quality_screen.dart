...
class _ClinkerQualityScreenState extends State<ClinkerQualityScreen> {
  ...
  final Map<String, Map<String, String>> featuresMeta = {
    ...
    'kiln_main_drive_power_kw': {
      'label': 'Kiln main drive power (kW)',
      'type': 'float',
      'desc': 'Main motor power for kiln',
    },
    ...
    'kiln_coating_thickness_mm': {
      'label': 'Kiln coating thickness (mm)',
      'type': 'float',
      'desc': 'Kiln coating thickness',
    },
    'kiln_refractory_status': {
      'label': 'Kiln refractory status',
      'type': 'string',
      'desc': 'Categorical status (e.g. good/bad)',
    ...
    'secondary_air_flow_nm3_hr': {
      'label': 'Secondary air flow (Nm3/hr)',
      'type': 'float',
      'desc': 'Secondary air flow rate',
    },
    ...
    'clinker_discharge_rate_tph': {
      'label': 'Clinker discharge rate (tph)',
      'type': 'float',
      'desc': 'Clinker discharge rate',
    },
    ...
    'preheater_inlet_temp_c': {
      'label': 'Preheater inlet temp (C)',
      'type': 'float',
      'desc': 'Preheater inlet temperature',
    },
    'preheater_outlet_temp_c': {
      'label': 'Preheater outlet temp (C)',
      'type': 'float',
      'desc': 'Preheater outlet temperature',
    },
  };
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (mode == 0)
                ClinkerQualitySingleSectionWidget(
                  featuresMeta: featuresMeta,
                  controllers: _controllers,
                  formKey: _formKey,
                ),
              if (mode == 1) ClinkerQualityBatchSectionWidget(selectedFile: selectedFile, onPick: _pickBatchFile, featuresMeta: featuresMeta),
